...
class DailyActivitiesPage extends ConsumerStatefulWidget {

  const DailyActivitiesPage({super.key});

  @override
  ConsumerState<DailyActivitiesPage> createState() =>
      _DailyActivitiesPageState();
}

class _DailyActivitiesPageState
    extends ConsumerState<DailyActivitiesPage> {
